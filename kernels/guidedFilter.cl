kernel void memset(__global unsigned char* src, __global unsigned char* dst, __global unsigned char* cost, int original_width, int original_height, int max_dist) {
