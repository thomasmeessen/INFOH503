kernel void memset(__global unsigned char* src, __global double* src_a_k, __global double* src_b_k, __global double* dst, int original_width, int original_height, int max_dist) {
    ...
    double a_k_sum_mean = a_k_sum / omega_size;
    double b_k_sum_mean = b_k_sum / omega_size;
    double source_pixel = (double) src[central_pixel- z*padded_image_size];
